...
let s:palette.bg        = { 'dark': "#400811"}

let s:palette.comment   = {'dark': "#D9455E"}
let s:palette.markup    = {'dark': "#F07178"}
let s:palette.constant  = {'dark': "#FFADC9"}
let s:palette.operator  = {'dark': "#FF6196"}
let s:palette.tag       = {'dark': "#CC8BA0"}
let s:palette.regexp    = {'dark': "#B36881"}
let s:palette.string    = {'dark': "#FFFAC7"}
let s:palette.function  = {'dark': "#DB0428"}
let s:palette.special   = {'dark': "#9C031D"}
let s:palette.keyword   = {'dark': "#A23446"}

let s:palette.error     = {'dark': "#FF3333"}
let s:palette.accent    = {'dark': "#A60570"}
